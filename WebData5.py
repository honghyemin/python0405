...
class Form(QMainWindow):
    ...
    def setupUI(self):
        ...
        # 버튼 clicked시그널(이벤트) --> setTalbleWidgetData(슬롯)
        self.btn.clicked.connect(self.setTableWidgetData)

        # 다중의 행과 열(엑셀) : 웹피이지 <table><td>..</td></tr></table>
        #       0열     1열 (컬럼2개)
        # 0행   (0,0)   (0,1)   (행,열)
        # 1행   (1,0)   (1,1)
        # 2행   (2,0)   (2,1)
    ...
    def doubleClicked(self):
        ...
        url = self.tableWidget.item(self.tableWidget.currentRow(), 
        1).text()
        webbrowser.open(url) 
